...
$arsipsurat
=mysql_num_rows(mysql_query("SELECT*FROM tb_admin"));
$jmlguru
=mysql_num_rows(mysql_query("SELECT*FROM tb_bagian"));
$laki = mysql_num_rows(mysql_query("SELECT*FROM tb_admin WHERE jk='laki-laki'"));
$pr =mysql_num_rows(mysql_query("SELECT*FROM tb_admin WHERE jk='perempuan'"));
?>
...
function drawChart(){
    ...
    ['pegawai',<?php echo"".$jmladmin."",?>]
    ['Staff',<?php echo"".$jmlbagian."",?>],

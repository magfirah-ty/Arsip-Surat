...
<html lang="en">
  <head>
    ...
    <title>Arsip Surat Kantor NOTARIS/PPAT</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">Kantor NOTARIS/PPAT</span></a>
            </div>
          ...
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN SURAT</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">Kantor NOTARIS/PPAT</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di Kantor NOTARIS/PPAT</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="img/fira.jpg" class="img-responsive">
              <figcaption>
                  <h2>MAQGFIRAH SALSABILA</h2>
                  <p>"Universiras Gajah Putih Teknik Informatika"</p>
